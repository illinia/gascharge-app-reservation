package com.gascharge.taemin.app.swagger;

import com.fasterxml.classmate.TypeResolver;
import com.gascharge.taemin.app.swagger.alternateType.PageableAlternativeRules;
import com.gascharge.taemin.app.swagger.alternateType.UserPrincipalAlternativeRules;
...
public class SwaggerConfig {
    ...
    public Docket commonApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .groupName("taemin")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.gascharge.taemin.app.controller"))
