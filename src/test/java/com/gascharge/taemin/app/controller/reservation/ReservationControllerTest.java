...
public class ReservationControllerTest {
    ...
    void reserve() throws Exception {
        ...
        this.mvc.perform(post("/reservation")
                ...
                .andDo(print())
                .andExpect(jsonPath("$.reservationValidationId").value(this.reservationTestAdmin.getReservationValidationId()))
    ...
    void forceUpdate() throws Exception {
        ...
        mvc.perform(patch("/reservation/" + reservationTest1.getReservationValidationId())
                ...
                .andDo(print())
                .andExpect(jsonPath("$.reservationValidationId").value(reservationTest1.getReservationValidationId()))
    ...
    void getList() throws Exception {
        ...
        ResultMatcher[] matchers = new ResultMatcher[] {
                jsonPath("$.content[0].reservationValidationId").value(this.reservationTestAdmin.getReservationValidationId()),
        ...
        ResultMatcher[] matchers1 = new ResultMatcher[] {
                jsonPath("$.content[1].reservationValidationId").value(this.reservationTestUser.getReservationValidationId()),
        ...
        // when
        when(reservationService.findAll(isNull(), anyString(), any(Pageable.class))).thenReturn(Collections.emptyList());
